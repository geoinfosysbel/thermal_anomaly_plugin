...
from .thermal_anomaly_dialog import ThermalAnomalyDialog
import os.path
...
class ThermalAnomaly:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'ThermalAnomaly_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&Тепловые аномалии')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('ThermalAnomaly', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/thermal_anomaly/icon.png'
        self.add_action(
            icon_path,
